...
<div align="center">
  <img src="./public/logo.svg" alt="RaidPack — ARC Raiders — Extraction" width="64" height="64">
  <h1>RaidPack — ARC Raiders — Extraction</h1>
</div>

Планировщик экспедиций и послесессионного учета ресурсов вручную.
...
- **Expedition loadout sheets** — запланированный модуль; реализации нет.
- **Resource priority lists** — запланированный модуль; реализации нет.
- **Extraction review journal** — запланированный модуль; реализации нет.
...
3. Опишите один контрольный сценарий для **Expedition loadout sheets**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="RaidPack — ARC Raiders — Extraction — specification review workflow">
<br>
...
Зафиксируйте входные данные и ожидаемый результат для модуля 1. Запишите версию ARC Raiders, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Resource priority lists

Зафиксируйте входные данные и ожидаемый результат для модуля 2. Запишите версию ARC Raiders, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Extraction review journal

Зафиксируйте входные данные и ожидаемый результат для модуля 3. Запишите версию ARC Raiders, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Кратко

| Поле | Значение |
|---|---|
| Продукт или область | ARC Raiders |
| Категория | Ручные игровые помощники |
| Входные данные | Ручные записи или разрешенный пользователем локальный экспорт |
| Планируемый результат | Expedition loadout sheets |
